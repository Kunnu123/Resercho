...
import com.resercho.EditPostActivity;
...
public class AdapterWork extends RecyclerView.Adapter<AdapterWork.ViewHolder> {
    ...
    public AdapterWork(Context context, List<ModelWork> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new AdapterWork.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        if (list.get(position).getPost_of().equalsIgnoreCase(DataHandler.getUserId(context))) {
            ...
            holder.editBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.d("Zink", "Media SRC:" + m.getMedia_src());
                    ...
                    Log.d("Fnd", "Fnd : Author:" + m.getAuthor());
                    ...
                    intent.putExtra("typeWork", m.getTypework());
        ...
        if (!horizontal && list.get(position).getType().equalsIgnoreCase("research") && list.get(position).getPost_of().equalsIgnoreCase(DataHandler.getUserId(context))) {
...
//                if (mime.equalsIgnoreCase("pdf")) {
        ...
        if (list.get(position).getPdflist() != null && list.get(position).getPdflist().size() > 0) {
            holder.imgCounter.setText(list.get(position).getPdflist().size() + " Document Attached");
...
//        todo: CardView mainlayout;
        ...
        public ViewHolder(View itemView) {
            ...
            editBtn = itemView.findViewById(R.id.editPostBtn);
